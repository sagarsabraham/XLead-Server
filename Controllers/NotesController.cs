...
namespace XLead_Server.Controllers
{
    ...
    public class NotesController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<NoteReadDto>>> GetNotesByDeal(long dealId, [FromQuery] long userId)
        {
            ...
            if (privileges == null || !privileges.Any(p => p.PrivilegeName == "PipelineDetailAccess"))
            {
                _logger.LogWarning($"User {userId} lacks 'PipelineDetailAccess' privilege to view notes.");
